...
{packedTime, GAUGE_NAME_TIME, "sec", 0},
	...
	{engine->outputChannels.tpsSecondaryADC, "tpsSecondaryADC", "ADC", 0},
	{engine->outputChannels.rawMaf, "rawMaf", "V", 3},
	{engine->outputChannels.mafMeasured, "MAF", "kg/h", 4},
	{engine->outputChannels.MAPValue, "MAP", "kPa", 4},
	{engine->outputChannels.baroPressure, "baroPressure", "kPa", 4},
	...
	{engine->outputChannels.actualLastInjPreSmallPw, "Actual Injection before Small PW", "ms", 3},
	...
	{engine->outputChannels.sparkDwellClamp, "Spark Dwell Clamp", "ms", 1},
	...
	{engine->outputChannels.veValue, "Fuel: VE", "ratio", 2},
	{engine->outputChannels.tunedVeValue, "tunedVE", "ratio", 2},
	{engine->outputChannels.tunedMafCorrection, "tunedMafCorrection", "ratio", 2},
	...
	{engine->outputChannels.rawOilTemperature, "rawOilTemperature", "V", 3},
	...
	{engine->outputChannels.AFRValue, "Air/Fuel Ratio", "AFR", 3},
	{engine->outputChannels.AFRValue2, "Air/Fuel Ratio 2", "AFR", 3},
	...
	{engine->outputChannels.rawAuxLinear1, "rawAuxLinear1", "V", 3},
	{engine->outputChannels.rawAuxLinear2, "rawAuxLinear2", "V", 3},
	{engine->outputChannels.rawAuxLinear3, "rawAuxLinear3", "V", 3},
	{engine->outputChannels.rawAuxLinear4, "rawAuxLinear4", "V", 3},
	{engine->outputChannels.fallbackMap, "fallbackMap", "kPa", 1},
	{engine->outputChannels.instantMAPValue, "Instant MAP", "kPa", 4},
	{engine->outputChannels.instantMAFValue, "Instant MAF", "kg/h", 2},
	...
	{engine->outputChannels.auxSpeed3, "Aux speed 3", "s", 0},
	{engine->outputChannels.auxSpeed4, "Aux speed 4", "s", 0},
	...
	{engine->outputChannels, 644, 0, "coilState1", ""},
	{engine->outputChannels, 644, 1, "coilState2", ""},
	{engine->outputChannels, 644, 2, "coilState3", ""},
	{engine->outputChannels, 644, 3, "coilState4", ""},
	{engine->outputChannels, 644, 4, "coilState5", ""},
	{engine->outputChannels, 644, 5, "coilState6", ""},
	{engine->outputChannels, 644, 6, "coilState7", ""},
	{engine->outputChannels, 644, 7, "coilState8", ""},
	{engine->outputChannels, 644, 8, "coilState9", ""},
	{engine->outputChannels, 644, 9, "coilState10", ""},
	{engine->outputChannels, 644, 10, "coilState11", ""},
	{engine->outputChannels, 644, 11, "coilState12", ""},
	{engine->outputChannels, 644, 12, "injectorState1", ""},
	{engine->outputChannels, 644, 13, "injectorState2", ""},
	{engine->outputChannels, 644, 14, "injectorState3", ""},
	{engine->outputChannels, 644, 15, "injectorState4", ""},
	{engine->outputChannels, 644, 16, "injectorState5", ""},
	{engine->outputChannels, 644, 17, "injectorState6", ""},
	{engine->outputChannels, 644, 18, "injectorState7", ""},
	{engine->outputChannels, 644, 19, "injectorState8", ""},
	{engine->outputChannels, 644, 20, "injectorState9", ""},
	{engine->outputChannels, 644, 21, "injectorState10", ""},
	{engine->outputChannels, 644, 22, "injectorState11", ""},
	{engine->outputChannels, 644, 23, "injectorState12", ""},
	{engine->outputChannels, 644, 24, "triggerChannel1", ""},
	{engine->outputChannels, 644, 25, "triggerChannel2", ""},
	{engine->outputChannels, 644, 26, "bank 1 intake cam input", ""},
	{engine->outputChannels, 644, 27, "bank 1 exhaust cam input", ""},
	{engine->outputChannels, 644, 28, "bank 2 intake cam input", ""},
	{engine->outputChannels, 644, 29, "bank 2 exhaust cam input", ""},
	...
	{engine->outputChannels.vehicleSpeedKphFrontAvg, "Wheel Speed Front AVG", "kph", 2},
	{engine->outputChannels.vehicleSpeedKphRearAvg, "Wheel Speed Rear AVG", "kph", 2},
	{engine->outputChannels.tracSpeedLeftRightREF, "LeftRightSpeedRef", "kph", 2},
	{engine->outputChannels.tracSpeedFrontRearREF, "FrontRearSpeedRef", "kph", 2},
	...
	{engine->outputChannels.wheelSlipRatioLeftRightFRONT, "wheelSlipRatioLeftRightFRONT", "", 0},
	{engine->outputChannels.wheelSlipRatioLeftRightREAR, "wheelSlipRatioLeftRightREAR", "", 0},
	{engine->outputChannels.wheelSlipRatioLeftRightREF, "wheelSlipRatioLeftRightREF", "", 0},
	{engine->outputChannels.wheelSlipRatioFrontRear, "wheelSlipRatioFrontRear", "", 0},
	{engine->outputChannels.canBoxTracTrim, "canBoxTracTrim", "%", 0},
	{engine->outputChannels.actualLastInjectionStage2, "Fuel: Last inj pulse width stg 2", "ms", 3},
	{engine->outputChannels.actualLastInjSTG2PreSmallPw, "actualLastInjSTG2PreSmallPw", "ms", 3},
	...
	{engine->outputChannels.rawAuxAnalog5, "rawAuxAnalog5", "V", 3},
	{engine->outputChannels.rawAuxAnalog6, "rawAuxAnalog6", "V", 3},
	{engine->outputChannels.rawAuxAnalog7, "rawAuxAnalog7", "V", 3},
	{engine->outputChannels.rawAuxAnalog8, "rawAuxAnalog8", "V", 3},
	...
	{engine->outputChannels.pedalToTpsIndex, "pedalToTpsIndex", "", 0},
	{engine->outputChannels.globalAFRTrim, "Global target AFR trim", "%", 3},
	{engine->outputChannels.lastCanButtonSeen, "lastCanButtonSeen", "", 0},
	{engine->outputChannels.lastCanButtonFoundIdx, "lastCanButtonFoundIdx", "", 0},
	...
	{engine->outputChannels.mapPerCylinder[0], "map per cylinder 1", "kPa", 6},
	{engine->outputChannels.mapPerCylinder[1], "map per cylinder 2", "kPa", 6},
	{engine->outputChannels.mapPerCylinder[2], "map per cylinder 3", "kPa", 6},
	{engine->outputChannels.mapPerCylinder[3], "map per cylinder 4", "kPa", 6},
	{engine->outputChannels.mapPerCylinder[4], "map per cylinder 5", "kPa", 6},
	{engine->outputChannels.mapPerCylinder[5], "map per cylinder 6", "kPa", 6},
	{engine->outputChannels.mapPerCylinder[6], "map per cylinder 7", "kPa", 6},
	{engine->outputChannels.mapPerCylinder[7], "map per cylinder 8", "kPa", 6},
	{engine->outputChannels.mapPerCylinder[8], "map per cylinder 9", "kPa", 6},
	{engine->outputChannels.mapPerCylinder[9], "map per cylinder 10", "kPa", 6},
	{engine->outputChannels.mapPerCylinder[10], "map per cylinder 11", "kPa", 6},
	{engine->outputChannels.mapPerCylinder[11], "map per cylinder 12", "kPa", 6},
	{engine->outputChannels.mafPerCylinder[0], "maf per cylinder 1", "kg/h", 6},
	{engine->outputChannels.mafPerCylinder[1], "maf per cylinder 2", "kg/h", 6},
	{engine->outputChannels.mafPerCylinder[2], "maf per cylinder 3", "kg/h", 6},
	{engine->outputChannels.mafPerCylinder[3], "maf per cylinder 4", "kg/h", 6},
	{engine->outputChannels.mafPerCylinder[4], "maf per cylinder 5", "kg/h", 6},
	{engine->outputChannels.mafPerCylinder[5], "maf per cylinder 6", "kg/h", 6},
	{engine->outputChannels.mafPerCylinder[6], "maf per cylinder 7", "kg/h", 6},
	{engine->outputChannels.mafPerCylinder[7], "maf per cylinder 8", "kg/h", 6},
	{engine->outputChannels.mafPerCylinder[8], "maf per cylinder 9", "kg/h", 6},
	{engine->outputChannels.mafPerCylinder[9], "maf per cylinder 10", "kg/h", 6},
	{engine->outputChannels.mafPerCylinder[10], "maf per cylinder 11", "kg/h", 6},
	{engine->outputChannels.mafPerCylinder[11], "maf per cylinder 12", "kg/h", 6},
	{engine->outputChannels.canButtons18, "canButtons18", "", 0},
	{engine->outputChannels, 904, 0, "canButtonToggle1", ""},
	{engine->outputChannels, 904, 1, "canButtonToggle2", ""},
	{engine->outputChannels, 904, 2, "canButtonToggle3", ""},
	{engine->outputChannels, 904, 3, "canButtonToggle4", ""},
	{engine->outputChannels, 904, 4, "canButtonToggle5", ""},
	{engine->outputChannels, 904, 5, "canButtonToggle6", ""},
	{engine->outputChannels, 904, 6, "canButtonToggle7", ""},
	{engine->outputChannels, 904, 7, "canButtonToggle8", ""},
	{engine->outputChannels.progPortOutput[0], "progPortOutput 1", "", 0},
	{engine->outputChannels.progPortOutput[1], "progPortOutput 2", "", 0},
	{engine->outputChannels.progPortOutput[2], "progPortOutput 3", "", 0},
	{engine->outputChannels.progPortOutput[3], "progPortOutput 4", "", 0},
	{engine->outputChannels.progPortOutput[4], "progPortOutput 5", "", 0},
	{engine->outputChannels.progPortOutput[5], "progPortOutput 6", "", 0},
	{engine->outputChannels.progPortOutput[6], "progPortOutput 7", "", 0},
	{engine->outputChannels.progPortOutput[7], "progPortOutput 8", "", 0},
	{engine->outputChannels.progPortOutput[8], "progPortOutput 9", "", 0},
	{engine->outputChannels.progPortOutput[9], "progPortOutput 10", "", 0},
	{engine->outputChannels.progPortOutput[10], "progPortOutput 11", "", 0},
	{engine->outputChannels.progPortOutput[11], "progPortOutput 12", "", 0},
	{engine->outputChannels.progPortOutput[12], "progPortOutput 13", "", 0},
	{engine->outputChannels.progPortOutput[13], "progPortOutput 14", "", 0},
	{engine->outputChannels.progPortOutput[14], "progPortOutput 15", "", 0},
	{engine->outputChannels.progPortOutput[15], "progPortOutput 16", "", 0},
	{engine->outputChannels.progPortOutput[16], "progPortOutput 17", "", 0},
	{engine->outputChannels.progPortOutput[17], "progPortOutput 18", "", 0},
	{engine->outputChannels.progPortOutput[18], "progPortOutput 19", "", 0},
	{engine->outputChannels.progPortOutput[19], "progPortOutput 20", "", 0},
	{engine->outputChannels.progPortOutput[20], "progPortOutput 21", "", 0},
	{engine->outputChannels.progPortOutput[21], "progPortOutput 22", "", 0},
	{engine->outputChannels.rawMCP3208_v_[0], "rawMCP3208_v_ 1", "", 0},
	{engine->outputChannels.rawMCP3208_v_[1], "rawMCP3208_v_ 2", "", 0},
	{engine->outputChannels.rawMCP3208_v_[2], "rawMCP3208_v_ 3", "", 0},
	{engine->outputChannels.rawMCP3208_v_[3], "rawMCP3208_v_ 4", "", 0},
	{engine->outputChannels.rawMCP3208_v_[4], "rawMCP3208_v_ 5", "", 0},
	{engine->outputChannels.rawMCP3208_v_[5], "rawMCP3208_v_ 6", "", 0},
	{engine->outputChannels.rawMCP3208_v_[6], "rawMCP3208_v_ 7", "", 0},
	{engine->outputChannels.rawMCP3208_v_[7], "rawMCP3208_v_ 8", "", 0},
	{engine->outputChannels.rawMCP3208_v_[8], "rawMCP3208_v_ 9", "", 0},
	{engine->outputChannels.rawMCP3208_v_[9], "rawMCP3208_v_ 10", "", 0},
	{engine->outputChannels.rawMCP3208_v_[10], "rawMCP3208_v_ 11", "", 0},
	{engine->outputChannels.rawMCP3208_v_[11], "rawMCP3208_v_ 12", "", 0},
	{engine->outputChannels.rawMCP3208_v_[12], "rawMCP3208_v_ 13", "", 0},
	{engine->outputChannels.rawMCP3208_v_[13], "rawMCP3208_v_ 14", "", 0},
	{engine->outputChannels.rawMCP3208_v_[14], "rawMCP3208_v_ 15", "", 0},
	{engine->outputChannels.rawMCP3208_v_[15], "rawMCP3208_v_ 16", "", 0},
	{engine->outputChannels.rawMCP3208_v_[16], "rawMCP3208_v_ 17", "", 0},
	{engine->outputChannels.rawMCP3208_v_[17], "rawMCP3208_v_ 18", "", 0},
	{engine->outputChannels.rawMCP3208_v_[18], "rawMCP3208_v_ 19", "", 0},
	{engine->outputChannels.rawMCP3208_v_[19], "rawMCP3208_v_ 20", "", 0},
	{engine->outputChannels.rawMCP3208_v_[20], "rawMCP3208_v_ 21", "", 0},
	{engine->outputChannels.rawMCP3208_v_[21], "rawMCP3208_v_ 22", "", 0},
	{engine->outputChannels.rawMCP3208_v_[22], "rawMCP3208_v_ 23", "", 0},
	{engine->outputChannels.rawMCP3208_v_[23], "rawMCP3208_v_ 24", "", 0},
	{engine->outputChannels, 1028, 0, "inj1ok", ""},
	{engine->outputChannels, 1028, 1, "inj2ok", ""},
	{engine->outputChannels, 1028, 2, "inj3ok", ""},
	{engine->outputChannels, 1028, 3, "inj4ok", ""},
	{engine->outputChannels, 1028, 4, "inj5ok", ""},
	{engine->outputChannels, 1028, 5, "inj6ok", ""},
	{engine->outputChannels, 1028, 6, "inj7ok", ""},
	{engine->outputChannels, 1028, 7, "inj8ok", ""},
	{engine->outputChannels, 1028, 8, "inj9ok", ""},
	{engine->outputChannels, 1028, 9, "inj10ok", ""},
	{engine->outputChannels, 1028, 10, "inj11ok", ""},
	{engine->outputChannels, 1028, 11, "inj12ok", ""},
	{engine->outputChannels, 1028, 12, "epic_hall_inp9", ""},
	{engine->outputChannels, 1028, 13, "epic_hall_inp10", ""},
	{engine->outputChannels, 1028, 14, "MAF from sensor seems valid", ""},
	{engine->outputChannels.epic_dinps18, "epic_dinps18", "", 0},
	{engine->outputChannels, 1036, 0, "epic_dinp1", ""},
	{engine->outputChannels, 1036, 1, "epic_dinp2", ""},
	{engine->outputChannels, 1036, 2, "epic_dinp3", ""},
	{engine->outputChannels, 1036, 3, "epic_dinp4", ""},
	{engine->outputChannels, 1036, 4, "epic_dinp5", ""},
	{engine->outputChannels, 1036, 5, "epic_dinp6", ""},
	{engine->outputChannels, 1036, 6, "epic_dinp7", ""},
	{engine->outputChannels, 1036, 7, "epic_dinp8", ""},
	{engine->outputChannels.epic_hall_inps18, "epic_hall_inps18", "", 0},
	{engine->outputChannels.epic_hall_inps916, "epic_hall_inps916", "", 0},
	{engine->outputChannels, 1044, 0, "epic_hall_inp1", ""},
	{engine->outputChannels, 1044, 1, "epic_hall_inp2", ""},
	{engine->outputChannels, 1044, 2, "epic_hall_inp3", ""},
	{engine->outputChannels, 1044, 3, "epic_hall_inp4", ""},
	{engine->outputChannels, 1044, 4, "epic_hall_inp5", ""},
	{engine->outputChannels, 1044, 5, "epic_hall_inp6", ""},
	{engine->outputChannels, 1044, 6, "epic_hall_inp7", ""},
	{engine->outputChannels, 1044, 7, "epic_hall_inp8", ""},
	{engine->outputChannels, 1044, 8, "wheelspeedFLerror", ""},
	{engine->outputChannels, 1044, 9, "wheelspeedFRerror", ""},
	{engine->outputChannels, 1044, 10, "wheelspeedRLerror", ""},
	{engine->outputChannels, 1044, 11, "wheelspeedRRerror", ""},
	{engine->outputChannels, 1044, 12, "wheelspeedFrontAvgError", ""},
	{engine->outputChannels, 1044, 13, "wheelspeedRearAvgError", ""},
	{engine->outputChannels, 1044, 14, "wheelspeedAvgError", ""},
	{engine->outputChannels, 1044, 15, "tracDisabled", ""},
	{engine->outputChannels.SparkLatencyCorrection, "SparkLatencyCorrection", "", 2},
	{engine->outputChannels.baroHasPressure, "baroHasPressure", "", 0},
	{engine->outputChannels.baroHasNoPressure, "baroHasNoPressure", "", 0},
	{engine->outputChannels, 1052, 0, "stage1InjSmallPwActive", ""},
	{engine->outputChannels, 1052, 1, "stage2InjSmallPwActive", ""},
	{engine->outputChannels, 1052, 2, "isMafAveraging", ""},
	{engine->outputChannels, 1052, 3, "stftNotUpdating", ""},
	{engine->outputChannels, 1052, 4, "stftNotCorrecting", ""},
	{engine->outputChannels.baroCounts, "baroCounts", "", 0},
	{engine->outputChannels.mafmapBlendPercentage, "mafmapBlendPercentage", "%", 2},
	{engine->outputChannels.mafmapAirmassSplit, "mafmapAirmassSplit", "%", 2},
	{engine->outputChannels.runningAirmass, "runningAirmass", "", 0},
	{engine->outputChannels.afrError, "afr Error %", "%", 3},
	{engine->outputChannels.tunedMassAirflow, "tunedMassAirflow", "", 0},
	{engine->outputChannels.dtTuneCurCycle, "dtTuneCurCycle", "", 0},
	{engine->outputChannels.dtTuneInjModeOverride, "dtTuneInjModeOverride", "", 0},
	...
	{engine->engineState.currentMafCorrection, "currentMafCorrection", "", 0},
	{engine->engineState.mafAirChargeLoad, "mafAirChargeLoad", "", 0},
	{engine->engineState.sdAirmass, "sdAirmass", "", 0},
	{engine->engineState.mafAirmass, "mafAirmass", "", 0},
	...
	{getLiveData<electronic_throttle_s>(0)->targetWithIdlePosition, "etb1ETB: target with idle", "%", 2, "ETB"},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
...
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(0)->luaAdjustment, "etb1ETB: luaAdjustment", "%", 2, "ETB"},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(0)->m_wastegatePosition, "etb1DC: wastegatePosition", "%", 2, "ETB"},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(0)->m_lastPidDtMs, "etb1EBT: last PID dT", "mS", 3, "ETB"},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(0)->etbFeedForward, "etb1etbFeedForward", "", 0},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(0)->integralError, "etb1Integral error", "", 3, "ETB"},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
...
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(0)->etbTpsErrorCounter, "etb1ETB TPS error counter", "count", 0, "ETB"},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(0)->etbPpsErrorCounter, "etb1ETB pedal error counter", "count", 0, "ETB"},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
...
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(1)->targetWithIdlePosition, "etb2ETB: target with idle", "%", 2, "ETB"},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
...
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(1)->luaAdjustment, "etb2ETB: luaAdjustment", "%", 2, "ETB"},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(1)->m_wastegatePosition, "etb2DC: wastegatePosition", "%", 2, "ETB"},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(1)->m_lastPidDtMs, "etb2EBT: last PID dT", "mS", 3, "ETB"},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(1)->etbFeedForward, "etb2etbFeedForward", "", 0},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(1)->integralError, "etb2Integral error", "", 3, "ETB"},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
...
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(1)->etbTpsErrorCounter, "etb2ETB TPS error counter", "count", 0, "ETB"},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
	{getLiveData<electronic_throttle_s>(1)->etbPpsErrorCounter, "etb2ETB pedal error counter", "count", 0, "ETB"},
#endif
#if EFI_PROD_CODE && EFI_ELECTRONIC_THROTTLE_BODY && FULL_SD_LOGS
...
#endif
	{engine->dc_motors.dcOutput0, "DC: output0", "%", 2, "ETB"},
	{engine->dc_motors.isEnabled0_int, "DC: en0", "%", 2, "ETB"},
