...
static AdcToken fastMafSampleIndex;
...
#if EFI_MAF_AVERAGING && defined (MODULE_MAF_AVERAGING)
	mafAveragingAdcCallback(adcRawValueToScaledVoltage(getFastAdc(fastMafSampleIndex), engineConfiguration->mafAdcChannel));
#endif
...
static void calcFastAdcIndexes() {
	...
	fastMafSampleIndex = enableFastAdcChannel("Fast MAF", engineConfiguration->mafAdcChannel);
...
PUBLIC_API_WEAK void boardStopHardware() { }
