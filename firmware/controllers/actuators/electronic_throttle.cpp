...
//	}
  ...
  float wheelSlipFrontRear = Sensor::getOrZero(SensorType::WheelSlipRatioFrontRear);
	...
	if (engine->outputChannels.canButtonToggle6 != 1 &&                                            // traction enable conditions
				...
				engineConfiguration->tcUseETB
      ) {

		tcEtbDrop = 0 - (interpolate3d(
			engineConfiguration->tractionControlEtbDropLeftRight,
		...
		interpolate3d(
			engineConfiguration->tractionControlEtbDropFrontRear,
