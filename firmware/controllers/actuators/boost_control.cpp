...
namespace {
    ...
    Map2D<BOOST_CURVE_SIZE, scaled_channel<unsigned char, 50, 1> , scaled_channel<signed char, 1, 2>> boostCltCorr { "clt" };
    Map2D<BOOST_CURVE_SIZE, scaled_channel<unsigned char, 50, 1> , scaled_channel<signed char, 1, 2>> boostIatCorr { "iat" };
    Map2D<BOOST_CURVE_SIZE, scaled_channel<unsigned char, 50, 1> , scaled_channel<signed char, 1, 2>> boostCltAdder { "clt (adder)" };
    Map2D<BOOST_CURVE_SIZE, scaled_channel<unsigned char, 50, 1> , scaled_channel<signed char, 1, 2>> boostIatAdder { "iat (adder)" };
