...
typedef enum {
	...
	TS_BUTTONBOX1_CATEGORY = 26,
	TS_HW_BUTTONBOX1_CATEGORY = 27,
	TS_UNUSED_28 = 28,
	TS_BOARD_ACTION = 29,
...
typedef enum {
	...
	AFR_TRIM_MIN,
	ALL_TRIM_RESET,
	CAN_BUTTON_TOGGLE1, // launch control enable
	CAN_BUTTON_TOGGLE2, // DFCO INVERT !
	CAN_BUTTON_TOGGLE3, // canbox idleup
	CAN_BUTTON_TOGGLE4, // air conditioning
	CAN_BUTTON_TOGGLE5, // antilag
	CAN_BUTTON_TOGGLE6, // traction control
	CAN_BUTTON_TOGGLE7,
	CAN_BUTTON_TOGGLE8,
	CAN_LUA_COMMAND_1,
	CAN_LUA_COMMAND_2,
	CAN_LUA_COMMAND_3,
	CAN_LUA_COMMAND_4,
    TRAC_TRIM_UP, // amplify slip, amplify slip more
    TRAC_TRIM_DOWN, // less slip, minimize slip signifficance
    TRAC_TRIM_RESET, // reset trac trim
    TRAC_TRIM_MAX, // max trac intervention, that is most amplification to slip
    TRAC_TRIM_MIN, // min trac intervention, that is least amplification to slip
	TRAC_TRIM_1, // trac adjustment preset 1
	TRAC_TRIM_2, // trac adjustment preset 2
	TRAC_TRIM_3, // trac adjustment preset 3
	TRAC_TRIM_4, // trac adjustment preset 4
