...
// was generated automatically by rusEFI tool  from rusefi_enums.h // by enum_to_string.jar tool on Thu Jun 05 10:12:57 GMT 2025
...
const char *getDrivetrain_layout_e(drivetrain_layout_e value){
switch(value) {
case DRIVETRAIN_AWD:
  return "DRIVETRAIN_AWD";
case DRIVETRAIN_FWD:
  return "DRIVETRAIN_FWD";
case DRIVETRAIN_RWD:
...
case ES_PLX:
  return "ES_PLX";
case ES_SPARTAN_LAMBDA:
  return "ES_SPARTAN_LAMBDA";
  }
 return NULL;
}
...
case AFR_MAFAirCharge:
  return "AFR_MAFAirCharge";
case AFR_MAP:
  return "AFR_MAP";
case AFR_None:
  return "AFR_None";
...
const char *getTrac_vss_source_e(trac_vss_source_e value){
switch(value) {
case VSS_SOURCE_FRONT:
  return "VSS_SOURCE_FRONT";
case VSS_SOURCE_FRONT_REAR_AVG:
  return "VSS_SOURCE_FRONT_REAR_AVG";
case VSS_SOURCE_REAR:
  return "VSS_SOURCE_REAR";
case VSS_SOURCE_VSS_SENSOR:
  return "VSS_SOURCE_VSS_SENSOR";
  }
 return NULL;
}
