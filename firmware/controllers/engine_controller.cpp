...
void commonInitEngineController() {
	...
	initElectronicThrottle();
        ...
        if (!engineConfiguration->disableMapAveraging) {
	...
	if (!engineConfiguration->disableMafAveraging) {
		engine->module<MafAveragingModule>()->init();
	}
#else
	efiPrintf("No MafAveraging support!");
#endif
...
// TODO: come back to this when we have mc33810 boards
