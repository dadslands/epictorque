...
void InjectionEvent::onTriggerTooth(efitick_t nowNt, float currentPhase, float nextPhase) {
	...
	// disable any injectors
	if (engineConfiguration->primaryInjectorDisabled1 && cylinderNumber == 0) return;
	if (engineConfiguration->primaryInjectorDisabled2 && cylinderNumber == 1) return;
	if (engineConfiguration->primaryInjectorDisabled3 && cylinderNumber == 2) return;
	if (engineConfiguration->primaryInjectorDisabled4 && cylinderNumber == 3) return;
	if (engineConfiguration->primaryInjectorDisabled5 && cylinderNumber == 4) return;
	if (engineConfiguration->primaryInjectorDisabled6 && cylinderNumber == 5) return;
	if (engineConfiguration->primaryInjectorDisabled7 && cylinderNumber == 6) return;
	if (engineConfiguration->primaryInjectorDisabled8 && cylinderNumber == 7) return;
	if (engineConfiguration->primaryInjectorDisabled9 && cylinderNumber == 8) return;
	if (engineConfiguration->primaryInjectorDisabled10 && cylinderNumber == 9) return;
	if (engineConfiguration->primaryInjectorDisabled11 && cylinderNumber == 10) return;
	if (engineConfiguration->primaryInjectorDisabled12 && cylinderNumber == 11) return;
