...
bool shouldSkipSpark(uint8_t cyl) {
	switch (cyl) {
		case 0: return  (engineConfiguration->ignitionDisabled1);
		case 1: return  (engineConfiguration->ignitionDisabled2);
		case 2: return  (engineConfiguration->ignitionDisabled3);
		case 3: return  (engineConfiguration->ignitionDisabled4);
		case 4: return  (engineConfiguration->ignitionDisabled5);
		case 5: return  (engineConfiguration->ignitionDisabled6);
		case 6: return  (engineConfiguration->ignitionDisabled7);
		case 7: return  (engineConfiguration->ignitionDisabled8);
		case 8: return  (engineConfiguration->ignitionDisabled9);
		case 9: return  (engineConfiguration->ignitionDisabled10);
		case 10: return (engineConfiguration->ignitionDisabled11);
		case 11: return (engineConfiguration->ignitionDisabled12);
...
void turnSparkPinHighStartCharging(IgnitionEvent *event) {
	...
	if (shouldSkipSpark(event->coilIndex)) return;
