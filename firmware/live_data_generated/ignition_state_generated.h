...
struct ignition_state_s {
	 ...
	 * offset 12
	 */
	scaled_channel<int16_t, 200, 1> cltTimingCorrection = (int16_t)0;
	/**
	 * Ign: IAT correction
	 * units: deg
	 * offset 14
	 */
	scaled_channel<int16_t, 200, 1> timingIatCorrection = (int16_t)0;
	/**
	 * Idle: Timing adjustment
	 * units: deg
	 * offset 16
	 */
	scaled_channel<int16_t, 200, 1> timingPidCorrection = (int16_t)0;
	/**
	 * DFCO: Timing retard
	 * units: deg
	 * offset 18
	 */
	scaled_channel<int16_t, 200, 1> dfcoTimingRetard = (int16_t)0;
	/**
	 ...
	 * offset 44
	 */
	scaled_channel<int16_t, 200, 1> trailingSparkAngle = (int16_t)0;
	/**
	 * need 4 byte alignment
	 * units: units
	 * offset 46
