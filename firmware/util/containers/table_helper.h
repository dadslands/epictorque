...
typedef Map3D<MAP_EST_RPM_COUNT, MAP_EST_LOAD_COUNT, uint16_t, scaled_channel<unsigned char, 1, 100>, uint16_t> mapEstimate_Map3D_t;
typedef Map3D<MAF_MAP_BLEND_SIZE, MAF_MAP_BLEND_SIZE, uint8_t, uint8_t, uint8_t> mafmapBlend_t;
