 ...
 * @brief Unit tests for torque control system
 */
...
TEST_F(TorqueControlTest, CANIntegration) {
    ...
    torqueControlModule.canManager.processTCURequest(frame);
...
TEST_F(TorqueControlTest, PerformanceBenchmark) {
    ...
    efiPrintf("Torque control performance: %.1f μs/cycle", avgTime);
}
