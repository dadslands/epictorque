...
public class TsOutputs {
	...
	public static final Field PEDALTOTPSINDEX = Field.create("PEDALTOTPSINDEX", 828, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field ALIGNMENTFILL_AT_829 = Field.create("ALIGNMENTFILL_AT_829", 829, FieldType.INT8).setScale(1.0).setBaseOffset(0);
	public static final Field GLOBALAFRTRIM = Field.create("GLOBALAFRTRIM", 832, FieldType.FLOAT).setBaseOffset(0);
	public static final Field LASTCANBUTTONSEEN = Field.create("LASTCANBUTTONSEEN", 836, FieldType.INT16).setScale(1.0).setBaseOffset(0);
	public static final Field LASTCANBUTTONFOUNDIDX = Field.create("LASTCANBUTTONFOUNDIDX", 838, FieldType.INT16).setScale(1.0).setBaseOffset(0);
	public static final Field CANBUTTONTOGGLE1 = Field.create("CANBUTTONTOGGLE1", 840, FieldType.BIT, 0).setBaseOffset(0);
	public static final Field CANBUTTONTOGGLE2 = Field.create("CANBUTTONTOGGLE2", 840, FieldType.BIT, 1).setBaseOffset(0);
	public static final Field CANBUTTONTOGGLE3 = Field.create("CANBUTTONTOGGLE3", 840, FieldType.BIT, 2).setBaseOffset(0);
	public static final Field CANBUTTONTOGGLE4 = Field.create("CANBUTTONTOGGLE4", 840, FieldType.BIT, 3).setBaseOffset(0);
	public static final Field CANBUTTONTOGGLE5 = Field.create("CANBUTTONTOGGLE5", 840, FieldType.BIT, 4).setBaseOffset(0);
	public static final Field CANBUTTONTOGGLE6 = Field.create("CANBUTTONTOGGLE6", 840, FieldType.BIT, 5).setBaseOffset(0);
	public static final Field CANBUTTONTOGGLE7 = Field.create("CANBUTTONTOGGLE7", 840, FieldType.BIT, 6).setBaseOffset(0);
	public static final Field CANBUTTONTOGGLE8 = Field.create("CANBUTTONTOGGLE8", 840, FieldType.BIT, 7).setBaseOffset(0);
	public static final Field ALIGNMENTFILL_AT_891 = Field.create("ALIGNMENTFILL_AT_891", 891, FieldType.INT8).setScale(1.0).setBaseOffset(0);
